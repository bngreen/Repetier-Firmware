...
#define EXT0_STEPS_PER_MM 86.0465
...
#define EXT0_PID_PGAIN_OR_DEAD_TIME 18.62
#define EXT0_PID_I 2.28
#define EXT0_PID_D 38.08
...
#define STEP_DOUBLER_FREQUENCY 40000
